...
const downloadPDF = () => {
  ...
  // To capture the full scrollable area, we measure the scrollHeight
  html2canvas(input, {
    backgroundColor: "#121212",
    scale: 2,
    useCORS: true,
    logging: false,
    // THESE TWO LINES FIX THE CUT-OFF ISSUE:
    ...
    // Check if the content is longer than one PDF page
    ...
    // If content is very long, add more pages
    while (heightLeft > 0) {
